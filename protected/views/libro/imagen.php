...
$this->breadcrumbs=array(
	'Libros'=>array('admin'),
	$model_libro->IdLibro=>array('update','id'=>$model_libro->IdLibro),
...
<div id="formulario_imagen">
	...
	<?php $form=$this->beginWidget('CActiveForm', array(
		...
		<?php if(Yii::app()->user->hasFlash("imagen")){?>
			<div class="flash-success">    
				<?php echo CHtml::image(Yii::app()->request->baseUrl."".Yii::app()->user->getFlash("imagen"),'',array('class'=>'flash_imagen'));?>    
				<div class="row buttons">
