...
<div class="container" id="page">
	...
	<?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
				...
				array('label'=>'<img src="'.Yii::app()->request->baseUrl.'/images/iconos/varios/carro.png" />   Mi Carrito (' . count(Yii::app()->user->getState('carrito')) . ')', 'url'=>array('/pedido/carrito'), 'visible'=>Yii::app()->user->checkAccess( 'cliente')|| Yii::app()->user->checkAccess( 'admin')|| Yii::app()->user->checkAccess( 'gerente')|| Yii::app()->user->checkAccess( 'vendedor')|| Yii::app()->user->checkAccess( 'libreria')),
			),
		)); ?>
	</div>
